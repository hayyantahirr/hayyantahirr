...
function Contact() {
  const socialLinks = [
    ...
    {
      href: "https://www.linkedin.com/in/hayyantahirr/",
      icon: (
        <svg
          width="24"
          height="24"
      ...
      <section className="section" id="contact">
        <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
          <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
            ...
            <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-[30ch] reveal-up">
              Let&apos;s work and collaborate together to make the project more
          ...
          <form
            action="https://getform.io/f/bollmrja"
            method="post"
            ...
            <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
              ...
              <div className="mb-4">
                ...
                <input
                  ...
                  autoComplete="email"
                  required
                  placeholder="hayyantahirr.example.com"
                  className="text-field reveal-up"
                />
              </div>
            </div>
